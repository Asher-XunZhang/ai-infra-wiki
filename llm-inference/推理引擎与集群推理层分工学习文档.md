...
Router 查询的 cache key、Worker 实际 block key、KV event 发布 key 必须在 model、tokens、adapter、salt、block 划分等字段上统一。否则 Router 看到的是过期或错误的缓存地图。相关案例见 [KV Cache Salt 全链路键空间学习文档](KV%20Cache%20Salt%20全链路键空间学习文档.md)。
...
- [Chunked Prefill 与 Prefill-Decode 共推学习文档](Chunked%20Prefill%20与%20Prefill-Decode%20共推学习文档.md)
- [Mooncake 与 vLLM 接入地图学习文档](../vllm/Mooncake%20与%20vLLM%20接入地图学习文档.md)
- [Mooncake 与 SGLang HiCache 学习文档](../sglang/Mooncake%20与%20SGLang%20HiCache%20学习文档.md)
