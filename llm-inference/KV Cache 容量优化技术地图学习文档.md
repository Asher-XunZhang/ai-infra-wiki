...
Hybrid model 可能同时有 FULL、SWA 和 recurrent state，它们的可复用边界并不一致。相关系统设计见 [SGLang Unified Radix Cache 学习文档](../sglang/SGLang%20Unified%20Radix%20Cache%20学习文档.md)。
...
- [LLM 推理系统心智模型与 SGLang、vLLM 选型边界学习文档](LLM%20推理系统心智模型与%20SGLang、vLLM%20选型边界学习文档.md)
- [vLLM V1 KV Cache 管理全生命周期源码学习文档](../vllm/vLLM%20V1%20KV%20Cache%20管理全生命周期源码学习文档.md)
