...
1. 不熟悉推理时，先读 [推理基础](<../llm-inference/foundations/README.md>) 或 [源码课程基础篇](<source-study/00-foundations/01-推理系统与SGLang职责地图.md>)。
...
| 高级生成 | [高级生成特性全景](<source-study/architecture/09-高级生成特性插入位置.md>) |
