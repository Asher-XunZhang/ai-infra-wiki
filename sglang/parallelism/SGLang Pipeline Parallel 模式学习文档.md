...
仓库里已经有一份基于指定 SGLang commit 逐行整理的 [PD 分离下的 PP 源码学习文档](../disaggregation/PD%20分离下的%20PP%20源码学习文档.md)。两份文档的边界不同：
...
- [HiCache 前缀命中源码学习文档](<../kv-cache/HiCache 前缀命中源码学习文档.md>) — 从请求键、页对齐和树匹配走到回载后的实际设备前缀。
- [HiCache 下 SGLang L1、L2、L3 与上传回载源码学习文档](<../kv-cache/HiCache 下 SGLang L1、L2、L3 与上传回载源码学习文档.md>) — 逐步追踪 D2H、L3 上传/预取、H2D、事件和资源释放。
...
- [PD 分离下的 PP 源码学习文档](../disaggregation/PD%20分离下的%20PP%20源码学习文档.md)
- [vLLM Pipeline Parallel 流水线并行学习文档](../../vllm/parallelism/vLLM%20Pipeline%20Parallel%20流水线并行学习文档.md)
