...
链式哈希和二分命中过程见 [vLLM APC 链式哈希学习文档](../kv-cache/vLLM%20APC%20链式哈希学习文档.md)。
...
- 前缀命中：[vLLM APC 链式哈希学习文档](../kv-cache/vLLM%20APC%20链式哈希学习文档.md)
- 分布式 KV 接入：[Mooncake 与 vLLM 接入地图学习文档](../disaggregation/Mooncake%20与%20vLLM%20接入地图学习文档.md)
- 跨框架心智模型：[LLM 推理系统心智模型与 SGLang、vLLM 选型边界学习文档](../../llm-inference/foundations/LLM%20推理系统心智模型与%20SGLang、vLLM%20选型边界学习文档.md)
