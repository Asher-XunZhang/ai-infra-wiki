...
本文默认读者已知道逻辑 KV block 的基本概念。KV Cache 的内存规划、prefix cache、引用计数、LRU、COW 和抢占见配套文档：[vLLM V1 KV Cache 管理全生命周期源码学习文档](../kv-cache/vLLM%20V1%20KV%20Cache%20管理全生命周期源码学习文档.md)。
